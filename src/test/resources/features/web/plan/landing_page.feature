...
Feature: Plan setup - Landing page
  ...
  @issue:DPTV-179 @issue:DPTV-576 @debug
  ...
  @issue:DPTV-765
    Scenario: Absence of pagination of landing page plan list
      Given there are less then 15 plans on landing page
